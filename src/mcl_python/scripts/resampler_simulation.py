...
ax.scatter(x_initial, y_initial, color='blue', marker='o', alpha=0.2, label='Initial')
...
for iteration in range(num_iterations):
    ...
    if iteration == 1:
        weights = [0.05, 0.15, 0.6, 0.05, 0.15]
    elif iteration == 2:
    ...
    ax.scatter(x_resampled, y_resampled,marker=marker, alpha=0.7, label='Iteration {}'.format(iteration + 1))
